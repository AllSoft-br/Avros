...
public class IfrmHistorico extends javax.swing.JInternalFrame {
     ...
     * @throws SQLException
     */
    private void preencheTabelaCad(List<Registro> registros) throws SQLException {
     ...
     * @throws SQLException
     */
    private void preencheTabelaDel(List<Registro> registros) throws SQLException {
     ...
     * @throws SQLException
     */
    private void preencheTabelaEdit(List<Registro> registros) throws SQLException {
     ...
     * @throws SQLException
     */
    private void preencheTabelaLog(List<Registro> registros) throws SQLException {
